...
const toggleMute = () => {
    if (videoPlayer.volume = 0) {
        faVolumeDown.classList.add('fa-pause');
        videoButtonPlay.classList.remove('fa-volume-down');
    } else {
        faVolumeDown.classList.remove('fa-pause');
        videoButtonPlay.classList.add('fa-volume-down');
    }
}
